<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div x-data="{ show: false }"
         x-init="$wire.on('flash-success', () => { show = true; setTimeout(() => show = false, 5000) })"
         x-show="show" x-cloak
        ...
        <span x-text="$wire.successMessage"></span>
        <button class="ml-auto shrink-0 text-green-500 hover:text-green-700" @click="show = false">
